function t(t) {
  ...
  function r(t) {
    ...
    function k() {
      !function () {
        W[0] = Math.round(b[0] += (l.y - b[0]) * .4);
        H[0] = Math.round(Y[0] += (l.x - Y[0]) * .4);
        for (let t = 1; t < z; t++) {
          W[t] = Math.round(b[t] += (W[t - 1] - b[t]) * .4);
      ...
      (function () {
        ...
        for (let t = 0; t < F.length; t++) {
          F[t].y = b[t] + 67.5 * Math.sin(-i + t * R * Math.PI / 180);
          F[t].x = Y[t] + 67.5 * Math.cos(-i + t * R * Math.PI / 180);
  ...
  function d(t) {
    ...
    let c = o.text ? " " + t.text : " Talk Drove";
    let l = t?.color || "#FFFFFF";
  ...
  export { h as bubbleCursor, i as characterCursor, r as clockCursor, c as emojiCursor, e as fairyDustCursor, s as followingDotCursor, l as ghostCursor, a as rainbowCursor, n as snowflakeCursor, t as springyEmojiCursor, d as HamzaText, o as trailingCursor };